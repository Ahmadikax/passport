...
if (isset($_GET['action']) && $_GET['action'] === 'export') {
    $filename = 'visa_requirements_with_ids_' . date('Y-m-d') . '.xls';
...
if (isset($_GET['action']) && $_GET['action'] === 'export_single' && isset($_GET['country'])) {
    ...
    // Set Excel headers for single country export
    header('Content-Type: application/vnd.ms-excel; charset=utf-8');
    header('Content-Disposition: attachment; filename="' . $country . '_visa_data_' . date('Y-m-d') . '.xls"');
...
<body>
    <div class="export-card">
        ...
        <p class="text-muted mb-4">Get Excel files containing visa data with country IDs for all countries or individual countries</p>
        ...
        <div class="stats">
            ...
            <div class="stat-item">
                <div class="stat-number">39,402</div>
        ...
        <div class="mt-4">
            <small class="text-muted">
                Files contain: from_country_id, Source Country, to_country_id, Destination Country, Visa Status, Visa Type, Duration, app_link
            </small>
        </div>
    </div>
