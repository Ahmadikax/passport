...
function extractVisaData($countryCode, $countryName) {
    ...
    foreach ($rows as $row) {
        ...
        $visaStatus = 'Unknown';
        if (strpos($visaType, 'visa-free') !== false) {
            $visaStatus = 'Visa Free';
        } elseif (strpos($visaType, 'visa required') !== false) {
            $visaStatus = 'Visa Required';
        } elseif (strpos($visaType, 'visa on arrival') !== false) {
            $visaStatus = 'Visa on Arrival';
        } elseif (strpos($visaType, 'eVisa') !== false) {
            $visaStatus = 'eVisa';
        } elseif (strpos($visaType, 'eTA') !== false) {
            $visaStatus = 'eTA';
        }
...
if (!isset($_GET['action'])) {
    ...
    // Write CSV header
    fputcsv($file, ['Source Country', 'Destination Country', 'Visa Status', 'Visa Type', 'Duration']);
...
function exportSingleCountry($countryCode) {
    ...
    fputcsv($output, ['Source Country', 'Destination Country', 'Visa Status', 'Visa Type', 'Duration']);
